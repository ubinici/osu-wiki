---
layout: post
title: "The Mappers' Report: Revival"
date: 2022-08-15 12:00:00 +0000
---

At last, we're back reporting the news from the heart of the mapping community, once again. Let's delve into what's the latest right away!

![](/wiki/shared/news/banners/the-mappers-report.jpg)

Did you miss us? Well, we sure did! It has been over a year since [our very last issue of the Mappers' Report](https://osu.ppy.sh/home/news/2021-06-20-mappers-report-may) after all. In case you have no idea what this is all about, be sure to check out the [wiki article](/wiki/The_Mappers_Report). Just like the old days, the Mappers' Report aims to cover everything mapping/modding in a newsletter format published periodically.

In doing so, however, we've changed some things on our side:
- We will be adopting a **quarterly** fashion, meaning that the Mappers' Report will be published every 3 months. We made this change because keeping things consistent every month tends to burn our writers out. Also, we plan to introduce several other *cool sections* demanding more time and effort, which will come forward in the following few issues.
- Our Mappers' Showcase section will now cover **4 mappers, each from a different ruleset**. We believe this will help us cover more diverse mappers in the long run and give the attention every game mode deserves.

This issue of the Mappers' Report contains the following sections:
...
Ermi also known as modding queue is really underrated and talented mapper from the Netherlands. Starting his mapping career from early 2019 and improving since then. 

Some people don't expect too much from mappers' first ranked maps, but ermi is actually changing these thoughts. He ranked his first map, LEO by Eve with his old name modding queue. This map is 3 minutes 55 seconds, and you can see how much effort he gave on this set by looking at the difficulties. He mapped Distorted Emotions and Hard difficulty by himself, then collabed Insane difficulty with Fuju.
This map actually challenging your aim control with his awesome circle patterns and well crafted 1/8 slider bursts. 

After ranking his map, he decided to revert his name back to Ermi. Three months passed, he ranked his second mapset unisonote by onoken. This map is circle size 6.2 with hard fingercontrol patterns. Slider patterning and map's flow is amazing with hard 1/8 336 bpm bursts. This map is his first and last ranked map on 2021. 
One year after he ranked anqad by onoken feat. b. It is actually the same artist with his second ranked mapset, but collabed with b. Patterning, cutstream flow is incredible and cant describe with words. Go check out his maps!

If we talk about his general style, mostly focusing on aesthetics, patterning and map's flow. He is nitpicky with his slider shapes and in love with slight curves. We can see he likes making challenging maps to players.

### MTNTwarz (osu!taiko)

*Written by **\[Zeth\]***

A mapper that has been around the community for some time but yet remains fairly hidden under the radar, [MTNTWarz](https://osu.ppy.sh/users/14036825) is a mapper that may not be familiar to most people, but is definitely a hidden gem amongst the osu!taiko mapping community.

While his debut towards the ranked section was rather plain, he had consistently shown his promises and potential as a mapper, and that has come into full force with his rendition of [Power Of Nature - Shounen wa Sora o Tadoru](https://osu.ppy.sh/beatmapsets/1588080). A rather unorthodox song choice with tons of time signature and rhythm changes, MTNTWarz has perfectly captured the feeling of the song with a map that is both incredibly chaotic to play and extremely clean in execution, both in patterning and SVs, not to mention a well done spread across the lower difficulties. This map only accumulates around 6,500 plays by the time of writing this, and we highly recommend you play it because it is truly an amazing map that is both enjoyable for the players, and a showing of good mapping ideas and execution for the mappers.

Besides showing his interest in rhythm game music filled with wacky rhythms and frequent tempo changes, he also delves regularly into traditional J-pop and J-rock songs that we all know and love, and does an excellent job in mapping them as well.  [PSYQUI feat. Mikanzil - Endroll](https://osu.ppy.sh/beatmapsets/1716530) is the best example of this, combining a frankly addicting and catchy J-rock anthem with a squeaky clean map that reflects the song to provide an overall fun experience for the players, beginners or veterans alike. To the song enjoyers who just want to jam to your favorite tune while mashing keys, this is a map that you should not miss out on.

Whether you are a player looking for challenging maps to test your ability, or a player looking for new songs to enjoy, MTNTWarz has both to offer and you will have a great time looking around his profile for maps to play that suits your way of enjoying the game.
